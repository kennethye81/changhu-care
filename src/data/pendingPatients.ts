...
export const PENDING_PATIENTS: PendingPatientData[] = [
  {
    ...
    contactName: '待录入', contactRelation: '儿子', contactPhone: '0519-8888-2002',
    medicalHistory: [
  ...
  },
  {
    ...
    doctor: '王医生', dischargeDate: '2026-07-03', referralDate: '2026-06-27',
  ...
  },
  {
    ...
    contactName: '王小凤', contactRelation: 'Wife', contactPhone: '0519-8888-2001',
    medicalHistory: [
      ...
      { date:'2026-06-18',type:'discharge',facility:'Prince of Wales Hospital',department:'Respiratory Medicine',physician:'Dr. Lee Mei Ling',chiefComplaint:'Clinically stable. Afebrile x48h. SpO₂ 92% on RA at rest.',diagnosis:'CAP (RLL consolidation) resolving. COPD GOLD Stage 2 stable. HTN controlled.',prescriptions:'Continue IV Ceftriaxone via HaH RN. PO Amoxicillin-clavulanate Days 8-10. Continue Tiotropium + Salbutamol PRN.',notes:'YDiCare 易护 HaH referral. Family trained on SpO₂/BP/Temp monitoring. NEWS Low (1) at discharge — routine NEWS2 monitoring.' },
    ],
  },
  {
