...
export const NEW_MEDICAL_HISTORY: Record<number, MedicalEntry[]> = {
  ...
  2: [
    ...
    },
    {
      ...
      note: '出院体格检查：瞳孔直径2mm，对光反射灵敏。左侧肢体能遵医嘱活动，右侧肢体刺痛无反应。右下肢肌层静脉血栓形成（Caprini 7分高危），避免挤压右下肢。Barthel约20分（全部需他人照护）。出院带药：无。',
      labs: '入院检验(12月19日): 血气PaO₂103mmHg·氧合指数312; 血常规中性粒83.7%·淋巴10.7%; 生化全套AKP126·GGT497·TBilD4.6·IBil18.7·TP59.0·ALB36.2·Cr53·UA545·Glu6.14·TG2.92·TC5.23·HDL1.58·Hcy24.7。12月20日: 血气pH7.46·PCO₂34·OI268·Lac2.5·Glu8.0·Temp37.7·Hct39%; 血常规WBC15.0·NEUT88.1%·hsCRP101.7; 肝功能GGT476·TP60.3·ALB35.9。12月31日复查: ALT215·AST101·AKP131·GGT372·Na133.8·TG2.95·TC6.82·HDL0.65·LDL4.27; CT示血肿范围增大（术后反应）; 下肢血管超声初诊未见异常→复查示右小腿深静脉血栓(部分型); CT灌注示多发腔隙灶+脑白质变性+动脉粥样硬化。',
      imaging: '头颅CT(12.18): 左侧基底节区血肿; 胸部CT: RUL结节+钙化灶·双下肺坠积性改变·心脏增大·胆囊结石。头颅CT(12.31): 血肿范围增大。CT灌注(12.31): 桥脑/小脑/基底节/放射冠/半卵圆中心多发腔隙灶·脑白质变性·老年脑改变·脑内动脉粥样硬化。下肢血管彩色多普勒(12.31初诊): 主动脉瓣轻微反流·左室壁增厚·左室舒张减退→复查: 右小腿深静脉血栓(部分型)。',
      procedures: '2023年12月21日急诊全麻下行立体定向颅内血肿穿刺引流术(左侧)。术后监控血压、护脑、护胃及补液对症治疗。',
      followUp: '2周后复查头颅胸部CT+血常规生化,心内科随访,脑外科门诊定期随访',
    },
    {
