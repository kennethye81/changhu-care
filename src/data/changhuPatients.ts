...
export const CHANGHU_PATIENTS: PatientFull[] = [
  // ═══════════════════════════════════════════════════════════
  // PATIENT 1 — 沈国栋 — Barthel 30分（重度依赖） · 高血压 · 压疮 · 极高跌倒风险
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    assessor: '李妍',
    idCard: '320506194907155431',
    emergencyContact: { name: '陈玉兰', phone: '13812340101', relation: '配偶' },
    ...
    nursingRecords: [
      {
        date: '2026-04-01',
        time: '10:00',
        note: '长护险初始评估。Barthel 30/100（重度依赖）。血压160/82，双侧肢体异常，已有压疮。跌倒风险105分极高危。配偶陈玉兰为紧急联系人。制定护理计划：q2h翻身、压疮护理、防跌倒措施、血压监测。',
        nurse: '姜珊',
  ...
  // ═══════════════════════════════════════════════════════════
  // PATIENT 10001 — 周志强 — Barthel 20分（重度依赖） · 脑出血术后 · 右侧偏瘫 · 右下肢DVT · 高血压
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    emergencyContact: { name: '周明辉', phone: '13998760202', relation: '子女' },
    ...
    nursingRecords: [
      {
        date: '2026-03-27',
        time: '10:00',
        note: '长护险初始评估。Barthel 20/100（重度失能）。Braden 14分高危，目前无压疮。右下肢DVT（Caprini 7分高危）。右侧偏瘫，左侧肢体正常。血压待监测。儿子周明辉为主要照护者，同住。制定护理计划：q2h翻身、压疮预防、血栓观察、被动ROM、二便管理。',
        nurse: '刘敏',
