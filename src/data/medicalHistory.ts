...
MEDICAL_HISTORY[1] = {
  patientId: 1,
  entries: [],
  aiSummary: '沈国栋，77岁男性，高血压3级极高危10年病史，不规则服药。临床轨迹：2025年11月初诊BP 172/95伴双下肢乏力（Barthel 30分重度依赖，Braden 10分压疮高危）→ 2025年12月血压部分控制（155/88）→ 2026年3月骶尾部压疮II期入院（3cm×4cm），提示长期卧床+营养不良导致皮肤完整性受损。AI核心关注：1. 血压管理 — 氨氯地平5mg+厄贝沙坦150mg方案下BP控制不充分，需优化GDMT并加强服药依从性监督；2. 压疮防控 — Braden 16分中度风险，翻身q2h+泡沫敷料+营养支持必不可少，社区护士每周换药监督；3. 跌倒风险极高（Morse 105分）— 助行器适配+居家安全改造+防跌倒教育；4. 功能衰退 — Barthel 30分重度依赖，双侧上下肢活动异常，需持续ADL协助；5. 照护者支持 — 陈玉兰（配偶）为主要照护者，需护理技巧培训及喘息服务。',
};
...
if (MEDICAL_HISTORY[2]) {
  MEDICAL_HISTORY[2].aiSummary = '周志强，64岁男性。2023年12月因左侧基底节脑出血急诊入院，行立体定向颅内血肿穿刺引流术后遗留右侧偏瘫。住院期间并发右下肢肌层静脉血栓（Caprini 7分高危）。2024年1月出院转入康复科，2026年3月27日长护险评估为重度失能（Barthel 20/100，Braden 14高危，跌到风险高危）。临床轨迹：高血压→脑出血→开颅手术→右侧偏瘫→DVT形成→长期卧床→二便失禁→重度依赖。意识清醒对答切题，全部生活需他人照护，儿子周明辉同住为主要照护者。AI核心关注：1. 压疮预防（Braden 14分高危，当前无压疮但必须每2小时翻身+减压气垫床+每日皮肤检查，≤12分立即升级重症方案）；2. 血栓安全管理（右下肢肌层静脉血栓，Caprini 7分高危，避免挤压、抬高患肢、每日观察肿胀/皮温/颜色，出现异常立即就医）；3. 跌到预防（右侧偏瘫+视力<0.3+高血压+降压药，转移需双人协助、床旁护栏、防滑地面，≥1次/季立即安全改造）；4. 血压管理（脑出血术后，降压方案待心内科确认，目标<150/90 mmHg，每日监测15次/月，注意体位性低血压）；5. 偏瘫康复（右侧肢体被动ROM锻炼，医嘱早期肘腕关节锻炼，避免关节挛缩，康复师陈军每月评估）；6. 失禁护理与照护者支持（二便失禁管理、按时更换尿垫/纸尿裤、会阴清洁防感染，家属周明辉培训翻身/ROM/血栓观察，目标照护技能≥70分）。';
}
