...
const DEFAULT_SUMMARIES_BASE: Omit<PatientSummary, 'newsScore' | 'newsTier' | 'rr' | 'bloodSugar'>[] = [
  ...
  { id: 2, name: '李玉富', gender: 'M', age: 64, diagnosis: '脑出血术后 · 右侧偏瘫 · 右下肢DVT · 高血压', temp: 36.5, hr: 72, bpSystolic: 145, bpDiastolic: 88, spo2: 97, hospital: '路桥区护理站（台州）', address: '台州市路桥区金清镇上盟村6区25号', doctor: '恩泽医院神经外科', caseManager: '张丽华' },
];
